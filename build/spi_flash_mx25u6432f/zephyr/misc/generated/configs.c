...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_JEDEC_MSPI_NOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_SQSPI_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_NRF_SQSPI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_MSPI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_MSPI_NOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_MSPI_NOR_LAYOUT_PAGE_SIZE, 65536);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOG_LEVEL_DBG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_INIT_PRIORITY, 70);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_COMPLETION_TIMEOUT_TOLERANCE, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_AMBIQ_BUFF_RAM_LOCATION, 0x50000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MSPI_AMBIQ_BUFF_ALIGNMENT, 4);
